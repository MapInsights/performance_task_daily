...
```{r echo=FALSE}
start <- as.Date(Sys.time() - (2*60*60*24))
start
```
...
LEFT JOIN (select jh.jobReference, min(jh.actionDate) as 'actionDate'from archive_echo_core_prod.dbo.job_history jh 
...
set @startDate = DATEADD(DAY, -4, getdate())
set @endDate = DATEADD(DAY, -3, getdate()) + '23:59:59'
...
set @yesterdayFROM = DATEADD(DAY, -3, CONVERT(CHAR(10), getdate(), 111))
set @yesterdayTO = DATEADD(DAY, -3, CONVERT(CHAR(10), getdate(), 111)) + '23:59:59'
