...
```{r echo=FALSE}
start <- as.Date(Sys.time() - (60*60*24)*2)
start
```
...
set @TO = DATEADD(DAY, -2, CONVERT(CHAR(10), getdate(), 111)) +'23:59:59'
...
set @endDate = DATEADD(DAY, -2, getdate()) + '23:59:59'
...
file <- jobhistory
yesterday <- as.Date(Sys.time()-(60*60*24)*2)
