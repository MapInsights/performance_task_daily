...
library(plotly)
library(flexdashboard)
#setwd('H:/performance_task_daily')
...
case when pickupAddress like '%Terminal 5%' then 'TW6, Term5' else pickupAddress end 'pickupAddress', delay,serviceId, source
from echo_core_prod..dynamic_delay_promises where (source = 8 or pickupAddress like '%Terminal 5%') and
