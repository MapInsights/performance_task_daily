...
declare @TO datetime
set @FROM ='2016-09-18' --DATEADD(DAY, -3, CONVERT(CHAR(10), getdate(), 111))
set @TO ='2016-09-18 23:59:59'-- DATEADD(DAY, -3, CONVERT(CHAR(10), getdate(), 111)) +'23:59:59'
...
LEFT JOIN (select jh.jobReference, min(jh.actionDate) as 'actionDate'from Archive_Echo_Core_Prod..job_history jh 
