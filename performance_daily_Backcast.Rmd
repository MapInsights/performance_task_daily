...
declare @TO datetime
set @FROM ='2016-06-01' --DATEADD(DAY, -1, CONVERT(CHAR(10), getdate(), 111))
set @TO = '2016-12-10'--DATEADD(DAY, -1, CONVERT(CHAR(10), getdate(), 111)) +'23:59:59'
...
set @yesterdayFROM = '2016-06-01' --DATEADD(DAY, -1, CONVERT(CHAR(10), getdate(), 111))
set @yesterdayTO = '2016-12-10'--DATEADD(DAY, -1, CONVERT(CHAR(10), getdate(), 111)) +'23:59:59'
