...
```{r echo= FALSE,fig.width=18, fig.height=10,warning=FALSE, message= FALSE}
day<-c(df_performance_DS_ontime$JobTotal,df_performance_DS_3min$Percent,df_performance_DS_ontime$Percent)
night<-c(df_performance_NS_ontime$JobTotal,df_performance_NS_3min$Percent,df_performance_NS_ontime$Percent)
total<-c(df_performance_ontime$JobTotal,df_performance_3min$Percent,df_performance_ontime$Percent)
