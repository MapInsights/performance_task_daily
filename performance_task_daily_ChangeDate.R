...
rmarkdown::render("performance_daily_ChangeDate.Rmd", "html_document", output_dir = "reports")
...
xlsx_name <- paste(as.Date(Sys.time() - (daysAgo*60*60*24)), "_", "results.xlsx", sep = '')
  
# Create mail lists
base_list <- "Daria.Alekseeva@greentomatocars.com;Julia.Thomas@transdevplc.co.uk);James.Rowe@greentomatocars.com;sean.sauter@transdevplc.co.uk;Christina.Stone@greentomatocars.com;Ian.Bates@greentomatocars.com;Lee.Holland@greentomatocars.com;controldesk@greentomatocars.com;Duncan.Fendom@greentomatocars.com;maxim.starostin@magenta-technology.com;petr.popov@magenta-technology.com;Paul.Jobling@greentomatocars.com;Tyrone.Hunte@greentomatocars.com;antony.carolan@greentomatocars.com;Haider.Variava@greentomatocars.com;Sophie.Jacobsen@greentomatocars.com"
...
outMail[["body"]] = "Good day. This is an automated e-mail. Daily performance report for previous date is attached. Daria"
outMail[["Attachments"]]$Add(paste(reports_dir,'performance_daily_ChangeDate.html', sep='/'))
